...
class _Started implements FavouritesEvent {
  const _Started();
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  loading,TResult Function( List<FavouriteItem> favourites)?  loaded,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Loading() when loading != null:
return loading();case _Loaded() when loaded != null:
return loaded(_that.favourites);case _Error() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  loading,required TResult Function( List<FavouriteItem> favourites)  loaded,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case _Loading():
return loading();case _Loaded():
return loaded(_that.favourites);case _Error():
return error(_that.message);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  loading,TResult? Function( List<FavouriteItem> favourites)?  loaded,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case _Loading() when loading != null:
return loading();case _Loaded() when loaded != null:
return loaded(_that.favourites);case _Error() when error != null:
...
class _Loading implements FavouritesState {
  const _Loading();
...
class _Loaded implements FavouritesState {
  const _Loaded({required final  List<FavouriteItem> favourites}): _favourites = favourites;
  

 final  List<FavouriteItem> _favourites;
 List<FavouriteItem> get favourites {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Loaded&&const DeepCollectionEquality().equals(other._favourites, _favourites));
}
...
@override
String toString() {
  return 'FavouritesState.loaded(favourites: $favourites)';
}
...
/// Create a copy of FavouritesState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? favourites = null,}) {
...
@override
String toString() {
  return 'FavouritesState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $FavouritesStateCopyWith<$Res> {
