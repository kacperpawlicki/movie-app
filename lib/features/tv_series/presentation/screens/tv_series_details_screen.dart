        ...
        child: ListView.separated(
          ...
          itemBuilder: (context, index) {
            return SizedBox(
              width: 130,
              child: MediaCard(
                title: similarTvSeries[index].name,
                voteAverage: similarTvSeries[index].voteAverage,
                imagePath: similarTvSeries[index].posterPath,
                onTap: () {
                  context.push('/tv/details/${similarTvSeries[index].id}');
                },
              ),
            );
          },
